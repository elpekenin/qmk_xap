...
export type Config = { layouts: Partial<{ [key in string]: Layout }>; matrix_size: Point2D }
...
export type LightingEffects = {
    groups: Partial<{ [key in string]: LightingGroup }> | null
    effects: Partial<{ [key in number]: LightingEffect }>
}
